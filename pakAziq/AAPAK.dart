void main() {
  ...
  Bon $bon Kasir : $kasir
  $pembatas1
  WALLS PP SHK150   2    $walls  ${walls * 2}
  TANGO CCHO 125G   2    $tango  ${tango * 2}
  CHITTATO SP PGGG6 1    $chitato1 ${chitato1 * 1}
  CHITTATO AYM BMG  1    $chitato2 ${chitato2 * 1}
  FRENCHFRIES 68G   1    $frenchfries  ${frenchfries * 1}
  $pembatas2
  ...
  sms 0817111234 https://alfamart.co.id/
  ''');
}